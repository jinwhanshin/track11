...
public class NewsDao {
	...
	public int newsDelete(String no){
		int result  = 0;
		String query="delete from home_신진환_news\r\n" + 
					 " where no ='"+no+"'";
		try {
	...
	public int newsUpdate(NewsDto dto){
		int result =0;
		String query="update home_신진환_news\r\n" + 
	...
	public NewsDto getNewsView(String no){
		...
		String query  ="select n.no, n.title, n.content, n.attach,  m.name, \r\n" + 
				...
				"from home_신진환_news n, home_신진환_member m\r\n" + 
				"where n.reg_id = m.id\r\n" + 
				"and n.no ='"+no+"'";
		try {
			con = DBConnection.getConnection();
...
//System.out.println(query);		
	...
	public int newsSave(NewsDto dto){
		int result = 0;
		/*
		String query="insert into home_신진환_news\r\n" + 
