...
public class MemberPasswordSend implements CommonExcute {
	...
	public void execute(HttpServletRequest request) {
		...
		if(memberName.equals("")) {
			...
			String newPassword = dao.getNewPassword(6);
		...
		try {	
			...
			if(result != 1) {
				...
				String mailSet_ID="freddie789";        // 보내는 메일 ID
				String mailSet_PW="zoafl1q2w!!";        // 보내는 메일 비밀번호
				
				String mailFromName ="JSL인재개발원";            // 보내는 사람 이름
				String mailFromAddress ="freddie789@naver.com"; // 보내는 메일 주소
				...
				try {
					...
					msg = "비밀번호 메일 발송 실패! 관리자에게 문의바랍니다.";
					e.printStackTrace();
				}
